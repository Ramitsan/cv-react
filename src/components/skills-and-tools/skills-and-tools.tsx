...
const tools = ['Git', 'VS Code', 'npm', 'Figma, Adobe Photoshop', 'DevTools', 'Gulp, Webpack', 'Pixel Perfect', 'WebP', 'MySQL', 'Docker', 'React DevTools', 'Redux DevTools', 'REST API', 'Axios', 'Jest', 'React Testing Library'];
  ...
  return (
    <section className="skills-and-tools">
        <div className="skills">
          ...
          <ul className="list-reset skills__list">
        ...
        <div className="tools">
          ...
          <ul className="list-reset tools__list">           
